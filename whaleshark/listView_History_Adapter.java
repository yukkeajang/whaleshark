...
public class listView_History_Adapter extends ArrayAdapter<TrainingsInfo>{
	 ...
	 */
	public listView_History_Adapter(Context context, int rowLayoutResource, List<TrainingsInfo> objects, String type)
	{
...
//			viewHolder.iv_image.setImageResource(Si.getMemberRankImg(data.getRank()));
			...
			viewHolder.bt_capture.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					TrainingHistoryAct.getCapture(v.getTag().toString());
				}
			});
		}else{
