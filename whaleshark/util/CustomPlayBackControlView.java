...
public class CustomPlayBackControlView extends FrameLayout {
    ...
    private final TextView playback_rate_control;
    ...
    public static Float current_playbackrate = 1.0f;
    ...
    public CustomPlayBackControlView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        playback_rate_control = (TextView) findViewById(R.id.playback_rate_control);
        tf.setNanumGothicExtraBold(context, playback_rate_control);
        ...
        minusButton.setOnClickListener(componentListener);
        plusButton= (ImageButton) findViewById(R.id.plus);
        plusButton.setOnClickListener(componentListener);
...
//        nextButton.setOnClickListener(componentListener);
        ...
        subTitleButton= (ImageButton) findViewById(R.id.subtitle);
        updateAll();
    }
...
//            Log.e("updateNavigation", currentTimeline.isEmpty()+"/"+currentWindowIndex+"/"+currentWindow);
...
//        Log.e("updateNavigation", bufferedPosition+" / "+position);
...
//        Log.e("progressBarValue","position : "+position);
...
//        Log.e("positionValue","progress : "+progress);
        long duration = player == null ? C.TIME_UNSET : player.getDuration();
...
//            Log.e("onProgressChanged","seekBar : "+seekBar);
            if (fromUser) {
...
//            Log.e("onLoadingChanged","isLoading : "+isLoading);
            // Do nothing.
        }
...
//            Log.e("onPlaybackParamChanged","playbackParameters : "+playbackParameters);
        }
...
//            } else
            if (previousButton == view) {
                ...
                player.setPlayWhenReady(!player.getPlayWhenReady());
            } else if (minusButton == view) {
                PlaybackParams params = new PlaybackParams();
                if(current_playbackrate > 0.1f) {
                ...
                playback_rate_control.setText("x " + str);
            } else if (plusButton == view) {
                PlaybackParams params = new PlaybackParams();
                if(current_playbackrate < 3.9f) {
                    current_playbackrate += 0.1f;
                    params.setSpeed(current_playbackrate);
                    player.setPlaybackParams(params);
                }
